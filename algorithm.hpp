                             ...
                             BinaryPredicate pred)
{
 return first1 == last1 || first2 == last2 ? last1
  : search(first1, last1, first2, last2, pred) == first1
     && search(first1 + 1, last1, first2, last2, pred) == last1 ? first1
...
{
 return first1 == last1 || find_if(first2, last2, bind2nd(pred, *first1)) != last2 ? first1
  : find_first_of(first1 + 1, last1, first2, last2, pred);
}
